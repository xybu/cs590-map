...
void rotate2d(yvecs, nmyvtxs,
              theta) double **yvecs; /* ptr to list of y-vectors (rotated) */
...
void rotate3d(
    yvecs, nmyvtxs, theta, phi,
    gamma2) double **yvecs; /* ptr to list of y-vectors (to be rotated) */
int nmyvtxs;                /* length of yvecs */
