...
void make_bpgraph(graph, sets, bndy_list, sep_size, set_match, ppointers,
                  pindices, pvweight, ploc2glob, pnleft, pnright,
...
void check_bpgraph(n_left, n_right, pointers, indices) int n_left, n_right,
    *pointers, *indices;
{
  int i, j, k, neighbor;
...
void print_bpgraph(nleft, nright, pointers, indices, vwgts) int nleft, nright,
    *pointers, *indices, *vwgts;
{
  FILE *file;
