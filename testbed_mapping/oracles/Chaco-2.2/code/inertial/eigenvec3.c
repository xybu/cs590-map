...
void evals3(H, eval1, eval2,
            eval3) double H[3][3]; /* 3x3 sym matrix for lowest eigenvalue */
...
void eigenvec3(A, eval, evec,
               res) double A[3][3]; /* matrix to find eigenvector of */
