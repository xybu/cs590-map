...
void assign_out(nvtxs, sets, nsets,
                outname) int nvtxs; /* number of vertices to output */
...
static void assign_out_normal(
    nvtxs, sets, outname) int nvtxs; /* number of vertices to output */
short *sets;                         /* values to be printed */
char *outname;                       /* name of output file */
{
...
static void assign_out_inv(
    nvtxs, sets, nsets, outname) int nvtxs; /* number of vertices to output */
short *sets;                                /* values to be printed */
int nsets;                                  /* number of sets */
char *outname;                              /* name of output file */
{
  ...
  for (j = 0; j < nsets; j++) size[j] = 0;
  for (i = 1; i <= nvtxs; i++) ++size[sets[i]];
