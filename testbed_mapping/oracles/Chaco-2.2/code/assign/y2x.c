...
void y2x(xvecs, ndims, nmyvtxs,
         wsqrt) double **xvecs; /* pointer to list of x-vectors */
...
void x2y(yvecs, ndims, nmyvtxs,
         wsqrt) double **yvecs; /* pointer to list of y-vectors */
