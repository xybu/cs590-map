...
void splarax(result, mat, n, vec, vwsqrt,
             work) double *result; /* result of matrix vector multiplication */
...
void splarax_float(
    result, mat, n, vec, vwsqrt,
    work) float *result; /* result of matrix vector multiplication */
struct vtx_data **mat;   /* graph data structure */
int n;                   /* number of rows/columns in matrix */
