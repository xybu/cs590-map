...
double *mkvec_ret(nl, nh) int nl, nh;
{
  double *v;
  double *smalloc_ret();
...
float *mkvec_float(nl, nh) int nl, nh;
{
  float *v;
  double *smalloc();
...
float *mkvec_ret_float(nl, nh) int nl, nh;
{
  float *v;
  double *smalloc_ret();
