...
void checkbp(graph, xvecs, sets, dists, nvtxs, ndims) struct vtx_data *
    *graph;     /* graph data structure for vertex weights */
...
int ndims;      /* number of dimensions for division */
{
  ...
  printf(" Sizes:");
  for (i = 0; i < nsets; i++) printf(" %d(%d)", sizes[i], weights[i]);
  printf("\n");
