...
void solistout(solist, n, ngood,
               j) struct orthlink **solist; /* vector of pntrs to orthlnks */
...
void solistout_float(
    solist, n, ngood,
    j) struct orthlink_float **solist; /* vector of pntrs to orthlnks */
int n;                                 /* length of vecs to orth. against */
int ngood;                             /* number of good vecs on list */
int j;                                 /* current number of Lanczos steps */
{
