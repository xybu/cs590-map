...
double read_val(infile, end_flag) FILE *infile; /* file to read value from */
...
int read_int(infile, end_flag) FILE *infile; /* file to read value from */
int *end_flag;                               /* 0 => OK, 1 => EOL, -1 => EOF */
{
...
static void flush_line(infile) FILE *infile; /* file to read value from */
{
