...
void perturb_init(n) int n; /* graph size at this level */
{
...
void perturb(result, vec) double *result; /* result of matrix-vector multiply */
...
void perturb_float(result,
                   vec) float *result; /* result of matrix-vector multiply */
