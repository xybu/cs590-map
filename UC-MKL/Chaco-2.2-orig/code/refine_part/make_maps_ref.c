...
void make_maps_ref(
    graph, set_list, vtx_elems, assignment, sub_assign, set1, set2, glob2loc,
    loc2glob, psub_nvtxs, pvwgt_max, pvwgt_sum1,
    pvwgt_sum2) struct vtx_data **graph; /* graph data structure */
